import{c as s,Q as n,j as p,m as e}from"./chunks/framework.Bhbi9jCp.js";const h=JSON.parse('{"title":"IAM 是什么:用户、角色、策略、临时凭证","description":"","frontmatter":{},"headers":[],"relativePath":"cloudBasicsLearning/27-IAM是什么.md","filePath":"cloudBasicsLearning/27-IAM是什么.md","lastUpdated":1779015580000}'),l={name:"cloudBasicsLearning/27-IAM是什么.md"};function t(i,a,o,c,r,d){return n(),p("div",null,[...a[0]||(a[0]=[e(`<h1 id="iam-是什么-用户、角色、策略、临时凭证" tabindex="-1">IAM 是什么:用户、角色、策略、临时凭证 <a class="header-anchor" href="#iam-是什么-用户、角色、策略、临时凭证" aria-label="Permalink to &quot;IAM 是什么:用户、角色、策略、临时凭证&quot;">​</a></h1><h2 id="一句话解释" tabindex="-1">一句话解释 <a class="header-anchor" href="#一句话解释" aria-label="Permalink to &quot;一句话解释&quot;">​</a></h2><p><strong>IAM 是云平台用来管理&quot;谁可以对哪些资源做什么操作&quot;的权限系统,核心概念通常是用户、角色、策略和临时凭证</strong>。</p><p>IAM 最容易被误解成&quot;创建子账号的地方&quot;。子账号只是 IAM 的一部分。真正重要的是权限表达能力:某个身份能不能读这个存储桶,能不能写这张数据库表,能不能删除服务器,能不能创建新的密钥。</p><p>如果账号安全解决的是&quot;谁能进门&quot;,IAM 解决的是&quot;进门之后能碰什么&quot;。没有 IAM,团队只能在&quot;全给管理员&quot;和&quot;完全不给&quot;之间摇摆。对云部署来说,这会让人和程序都拿到过大的权限。</p><h2 id="放在系统哪里" tabindex="-1">放在系统哪里 <a class="header-anchor" href="#放在系统哪里" aria-label="Permalink to &quot;放在系统哪里&quot;">​</a></h2><p>IAM 位于管理面和资源面之间:</p><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>人 / 程序 / CI/CD / 云服务</span></span>
