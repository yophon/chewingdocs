...
<span class="line"><span>  - 不相关 → 后面再说</span></span></code></pre></div><p><strong>SRE 不是&quot;做得越像 Google 越好&quot;,是&quot;做到适合自己团队规模&quot;——这个判断本身就是 SRE 工程的一部分</strong>。</p><hr><h2 id="七、本篇的实战配置示例" tabindex="-1">七、本篇的实战配置示例 <a class="header-anchor" href="#七、本篇的实战配置示例" aria-label="Permalink to &quot;七、本篇的实战配置示例&quot;">​</a></h2><p>讲了 4 个概念,<strong>这一节给一些可以直接落地的&quot;工程产物&quot;</strong>——把概念变成代码 / 配置。</p><h3 id="_7-1-错误预算的-promql-计算" tabindex="-1">7.1 错误预算的 PromQL 计算 <a class="header-anchor" href="#_7-1-错误预算的-promql-计算" aria-label="Permalink to &quot;7.1 错误预算的 PromQL 计算&quot;">​</a></h3><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># 假设有指标:http_requests_total{status, service}</span></span>
<span class="line"><span></span></span>
