import{_ as a,H as n,f as i,i as p}from"./chunks/framework.BHvCMIhP.js";const r=JSON.parse('{"title":"终端 + Claude Code 工作流:用得好和用得烂差 5 倍生产力","description":"","frontmatter":{},"headers":[],"relativePath":"../terminalLearning/29-终端与Claude-Code工作流.md","filePath":"../terminalLearning/29-终端与Claude-Code工作流.md","lastUpdated":1778574438000}'),e={name:"../terminalLearning/29-终端与Claude-Code工作流.md"};function l(t,s,h,d,o,k){return n(),i("div",null,[...s[0]||(s[0]=[p(`<h1 id="终端-claude-code-工作流-用得好和用得烂差-5-倍生产力" tabindex="-1">终端 + Claude Code 工作流:用得好和用得烂差 5 倍生产力 <a class="header-anchor" href="#终端-claude-code-工作流-用得好和用得烂差-5-倍生产力" aria-label="Permalink to &quot;终端 + Claude Code 工作流:用得好和用得烂差 5 倍生产力&quot;">​</a></h1><p>打开你身边任何一个用 Claude Code 的同事,看他怎么用的。<strong>九成是这样</strong>:</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>他打开 VS Code,在底部 Terminal 里跑一个 claude</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 然后正常 git / rg / just test</span></span></code></pre></div><p><strong>结果</strong>:你在一个 tmux 里同时看 Claude 和自己的 shell,<strong>Claude 跑长任务时你切右 pane 干别的事</strong>。</p><h3 id="_3-2-justfile-一键起-dev-环境" tabindex="-1">3.2 Justfile 一键起 dev 环境 <a class="header-anchor" href="#_3-2-justfile-一键起-dev-环境" aria-label="Permalink to &quot;3.2 Justfile 一键起 dev 环境&quot;">​</a></h3><p>把 27 / 28 篇的 Justfile 接进来。在项目根加一段 recipe:</p><div class="language-just vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">just</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># Justfile</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>                                                └ 远端机不睡觉</span></span></code></pre></div><h3 id="_4-2-一次性配置-ssh-tmux" tabindex="-1">4.2 一次性配置 ssh + tmux <a class="header-anchor" href="#_4-2-一次性配置-ssh-tmux" aria-label="Permalink to &quot;4.2 一次性配置 ssh + tmux&quot;">​</a></h3><p>15 篇 ssh 深用 + 16/17 篇 tmux 配过的话,这一步就是几行:</p><div class="language-ssh vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ssh</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># ~/.ssh/config</span></span>
...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">$</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> git</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> branch</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -D</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> refactor-branch</span></span></code></pre></div><p><strong>这套姿势让 Claude 大改不必担心污染主工作目录</strong>——你 main 分支随时能 <code>pnpm dev</code> 验证,Claude 的实验在另一个目录里独立进行。</p><h3 id="_7-4-配-justfile-一键-worktree" tabindex="-1">7.4 配 Justfile 一键 worktree <a class="header-anchor" href="#_7-4-配-justfile-一键-worktree" aria-label="Permalink to &quot;7.4 配 Justfile 一键 worktree&quot;">​</a></h3><div class="language-just vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">just</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># Justfile</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span style="--shiki-light:#E36209;--shiki-dark:#FFAB70;">-</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> just deploy &lt;env&gt; 部署</span></span>
<span class="line"></span>
...
<span class="line"><span>└─────────────────────────────────────────────────────────────┘</span></span></code></pre></div><h3 id="_14-2-ssh-agent-forwarding-共享-github-key" tabindex="-1">14.2 ssh agent forwarding:共享 GitHub key <a class="header-anchor" href="#_14-2-ssh-agent-forwarding-共享-github-key" aria-label="Permalink to &quot;14.2 ssh agent forwarding:共享 GitHub key&quot;">​</a></h3><div class="language-ssh vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ssh</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># ~/.ssh/config</span></span>
<span class="line"><span>Host dev</span></span>
