...
<span class="line"><span>□ 命令行前 4 个空格或 Tab 都可以           ← Tab 教徒终于解放</span></span></code></pre></div><h3 id="_3-3-关键特性-1-参数和默认值" tabindex="-1">3.3 关键特性 1:参数和默认值 <a class="header-anchor" href="#_3-3-关键特性-1-参数和默认值" aria-label="Permalink to &quot;3.3 关键特性 1:参数和默认值&quot;">​</a></h3><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># 单参数,无默认值</span></span>
...
<span class="line"><span># $ just --jobs 4 lint test</span></span></code></pre></div><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># 链式 recipe 调用(在 recipe 体内调用其他 recipe)</span></span>
...
<span class="line"><span>    cargo publish</span></span></code></pre></div><h3 id="_3-5-关键特性-3-shell-嵌入-用任何解释器" tabindex="-1">3.5 关键特性 3:shell 嵌入(用任何解释器) <a class="header-anchor" href="#_3-5-关键特性-3-shell-嵌入-用任何解释器" aria-label="Permalink to &quot;3.5 关键特性 3:shell 嵌入(用任何解释器)&quot;">​</a></h3><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># 默认是 sh / bash(每行独立)</span></span>
<span class="line"><span>test:</span></span>
<span class="line"><span>    cargo test</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>    build({ entryPoints: [&quot;src/main.ts&quot;], bundle: true, outfile: &quot;dist/main.js&quot; });</span></span></code></pre></div><p><strong>这是 just 比 Make 强很多的地方</strong>——一个项目可能同时用 bash、python、node 写不同任务,<strong>just 让每个 recipe 自己选解释器,不用学 Make 的 ONESHELL 黑魔法</strong>。</p><h3 id="_3-6-关键特性-4-平台分支" tabindex="-1">3.6 关键特性 4:平台分支 <a class="header-anchor" href="#_3-6-关键特性-4-平台分支" aria-label="Permalink to &quot;3.6 关键特性 4:平台分支&quot;">​</a></h3><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># macOS 专用</span></span>
...
<span class="line"><span>[linux]</span></span>
<span class="line"><span>open-config:</span></span>
<span class="line"><span>    xdg-open ~/.config/foo.toml</span></span></code></pre></div><p><strong><code>just install</code> 在 macOS 跑 brew,在 Linux 跑 apt</strong>——一个 Justfile 团队全平台用,这是 Make 做不到的。</p><h3 id="_3-7-关键特性-5-变量与环境" tabindex="-1">3.7 关键特性 5:变量与环境 <a class="header-anchor" href="#_3-7-关键特性-5-变量与环境" aria-label="Permalink to &quot;3.7 关键特性 5:变量与环境&quot;">​</a></h3><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># 顶级变量</span></span>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">alias</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> jc</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;just --choose&#39;</span></span></code></pre></div><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">$</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> jc</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">                       # fzf 选 recipe,Enter 跑</span></span></code></pre></div><p><strong>自定义选择器</strong>:</p><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># Justfile 顶部</span></span>
...
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">  ...</span></span></code></pre></div><h3 id="_11-1-配置" tabindex="-1">11.1 配置 <a class="header-anchor" href="#_11-1-配置" aria-label="Permalink to &quot;11.1 配置&quot;">​</a></h3><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># Justfile 顶部</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">                  新人完全猜不到是 tab 问题</span></span></code></pre></div><p><strong>这种坑就是工具语法的设计税</strong>——<strong>Just 用 4 个空格或 Tab 都接受</strong>,直接消除这类问题。<strong>如果你和团队还在为 Tab/空格争执,迁 Just 立刻解决</strong>。</p><h3 id="_12-5-反对-5-把-justfile-写得像-make-的味儿" tabindex="-1">12.5 反对 5:把 Justfile 写得像 Make 的味儿 <a class="header-anchor" href="#_12-5-反对-5-把-justfile-写得像-make-的味儿" aria-label="Permalink to &quot;12.5 反对 5:把 Justfile 写得像 Make 的味儿&quot;">​</a></h3><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># 反例:写出 Makefile 的味</span></span>
...
<span class="line"><span>    do_stuff</span></span></code></pre></div><p><strong>别把 Make 的肌肉记忆带进 Just</strong>,学一次新语法,然后写出干净的 Justfile。</p><h3 id="_12-6-反对-6-justfile-写一堆只跑一次的命令" tabindex="-1">12.6 反对 6:Justfile 写一堆只跑一次的命令 <a class="header-anchor" href="#_12-6-反对-6-justfile-写一堆只跑一次的命令" aria-label="Permalink to &quot;12.6 反对 6:Justfile 写一堆只跑一次的命令&quot;">​</a></h3><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># 反例:这是一次性脚本不是任务</span></span>
