import{c as s,Q as n,j as p,m as e}from"./chunks/framework.CBiVa4O3.js";const d=JSON.parse('{"title":"OAuth、OIDC 与 SSO:登录不是自己存密码这么简单","description":"","frontmatter":{},"headers":[],"relativePath":"../cloudBasicsLearning/29-OAuthOIDC与SSO.md","filePath":"../cloudBasicsLearning/29-OAuthOIDC与SSO.md","lastUpdated":1779015580000}'),t={name:"../cloudBasicsLearning/29-OAuthOIDC与SSO.md"};function i(l,a,o,c,u,h){return n(),p("div",null,[...a[0]||(a[0]=[e(`<h1 id="oauth、oidc-与-sso-登录不是自己存密码这么简单" tabindex="-1">OAuth、OIDC 与 SSO:登录不是自己存密码这么简单 <a class="header-anchor" href="#oauth、oidc-与-sso-登录不是自己存密码这么简单" aria-label="Permalink to &quot;OAuth、OIDC 与 SSO:登录不是自己存密码这么简单&quot;">​</a></h1><h2 id="一句话解释" tabindex="-1">一句话解释 <a class="header-anchor" href="#一句话解释" aria-label="Permalink to &quot;一句话解释&quot;">​</a></h2><p><strong>OAuth 主要解决授权访问,OIDC 在 OAuth 之上解决登录身份,SSO 解决一次登录访问多个系统;它们的边界是:不要把&quot;能调 API&quot;误当成&quot;已经可信登录&quot;</strong>。</p><p>很多人第一次接触 OAuth,是在网站上做&quot;使用 Google / GitHub 登录&quot;。于是很容易以为 OAuth 就是第三方登录协议。更准确地说,OAuth 2.0 关注的是授权:用户允许某个应用访问某些资源。OIDC 才是在 OAuth 2.0 基础上增加身份层,让应用能可靠知道&quot;这个用户是谁&quot;。</p><p>SSO 则是另一层概念。它不是某一个具体协议,而是一种登录体验和组织能力:用户在身份提供方登录一次,就能访问多个内部系统。SSO 背后可以用 OIDC,也可以用 SAML。对小团队来说,重点不是背协议细节,而是知道登录、授权、组织身份管理不是同一件事。</p><h2 id="放在系统哪里" tabindex="-1">放在系统哪里 <a class="header-anchor" href="#放在系统哪里" aria-label="Permalink to &quot;放在系统哪里&quot;">​</a></h2><p>登录协议位于用户身份链路里:</p><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>用户</span></span>
