import{_ as s,H as n,f as p,i as l}from"./chunks/framework.BHvCMIhP.js";const u=JSON.parse('{"title":"监控是什么:指标、日志、链路追踪的分工","description":"","frontmatter":{},"headers":[],"relativePath":"../cloudBasicsLearning/21-监控是什么.md","filePath":"../cloudBasicsLearning/21-监控是什么.md","lastUpdated":1779015580000}'),e={name:"../cloudBasicsLearning/21-监控是什么.md"};function i(t,a,c,o,h,d){return n(),p("div",null,[...a[0]||(a[0]=[l(`<h1 id="监控是什么-指标、日志、链路追踪的分工" tabindex="-1">监控是什么:指标、日志、链路追踪的分工 <a class="header-anchor" href="#监控是什么-指标、日志、链路追踪的分工" aria-label="Permalink to &quot;监控是什么:指标、日志、链路追踪的分工&quot;">​</a></h1><blockquote><p>一句话先记住:<strong>监控不是摆几张漂亮图表,而是在系统出问题前后,让你知道哪里异常、影响多大、该先查什么</strong>。</p></blockquote><p>很多人把监控理解成 CPU、内存、磁盘三张图。它们当然有用,但对一个真实网站或 SaaS 来说远远不够。用户登录失败、支付回调丢失、CDN 回源异常、数据库连接打满、第三方接口变慢,这些都可能发生在机器指标看起来还正常的时候。</p><p>监控的目标不是&quot;看起来专业&quot;,而是缩短三个时间:</p><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>发现问题的时间</span></span>
