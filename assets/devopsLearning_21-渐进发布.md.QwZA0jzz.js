import{c as a,Q as n,j as p,m as i}from"./chunks/framework.Bhbi9jCp.js";const g=JSON.parse('{"title":"渐进发布:蓝绿 / 金丝雀 / 影子流量 / 自动 rollback","description":"","frontmatter":{},"headers":[],"relativePath":"devopsLearning/21-渐进发布.md","filePath":"devopsLearning/21-渐进发布.md","lastUpdated":1779604575000}'),l={name:"devopsLearning/21-渐进发布.md"};function t(e,s,o,r,h,c){return n(),p("div",null,[...s[0]||(s[0]=[i(`<h1 id="渐进发布-蓝绿-金丝雀-影子流量-自动-rollback" tabindex="-1">渐进发布:蓝绿 / 金丝雀 / 影子流量 / 自动 rollback <a class="header-anchor" href="#渐进发布-蓝绿-金丝雀-影子流量-自动-rollback" aria-label="Permalink to &quot;渐进发布:蓝绿 / 金丝雀 / 影子流量 / 自动 rollback&quot;">​</a></h1><p>上一篇讲了 GitOps——<code>git push</code> 一推,ArgoCD 跟着把声明同步到集群。但这只解决了&quot;声明到达&quot;的问题,<strong>没解决&quot;声明到达之后,这个新版本会不会把生产打挂&quot;这个问题</strong>。这一篇就来回答它。</p><p>发布这件事,80% 团队的做法是「合 PR → CI 过 → 一键 deploy → 全量上线」。<strong>这条路在 5 个微服务 / 100 QPS 时勉强能跑,过了 50 个微服务 / 5000 QPS,Change Failure Rate 就会从 5% 飙到 30%</strong>——也就是说,每三次发布就有一次会撞出生产事故。这不是&quot;开发不努力&quot;,是**&quot;全量发布&quot;这个模式本身就不适合中等规模的系统**。</p><blockquote><p>一句话先记住:<strong>渐进发布不是&quot;为了稳&quot;才做的,是&quot;为了让事故发现得早、影响得小&quot;才做的</strong>——它的目标不是降低事故率(降不了多少,bug 该出还是会出),是<strong>把&quot;全量翻车&quot;压缩成&quot;1% 翻车&quot;</strong>,把 MTTR 从&quot;全员加班&quot;压缩成&quot;一次自动 rollback&quot;。我见过太多团队认为&quot;我们 CI 跑得很全,不需要灰度&quot;——CI 测的是&quot;代码逻辑对不对&quot;,<strong>生产环境暴露的是&quot;代码在真实流量 / 真实数据 / 真实下游组合下对不对&quot;</strong>,这两件事是平行的,任何一边都不能替代另一边。</p></blockquote><hr><h2 id="一、问题场景-全量发布的三种死法" tabindex="-1">一、问题场景:全量发布的三种死法 <a class="header-anchor" href="#一、问题场景-全量发布的三种死法" aria-label="Permalink to &quot;一、问题场景:全量发布的三种死法&quot;">​</a></h2><p>全量发布的失败模式有很多,但根上的就是三类——<strong>bug 一上线全员中招、性能问题没有任何预警、rollback 慢得离谱</strong>。下面分别说。</p><h3 id="_1-1-死法一-bug-一上线-全员中招" tabindex="-1">1.1 死法一:bug 一上线,全员中招 <a class="header-anchor" href="#_1-1-死法一-bug-一上线-全员中招" aria-label="Permalink to &quot;1.1 死法一:bug 一上线,全员中招&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>14:00  发布 v2.3.0(增加优惠券校验逻辑)</span></span>
