import{c as a,Q as n,j as i,m as p}from"./chunks/framework.CBiVa4O3.js";const r=JSON.parse('{"title":"终端 + Claude Code 工作流:用得好和用得烂差 5 倍生产力","description":"","frontmatter":{},"headers":[],"relativePath":"../terminalLearning/29-终端与Claude-Code工作流.md","filePath":"../terminalLearning/29-终端与Claude-Code工作流.md","lastUpdated":1778574438000}'),e={name:"../terminalLearning/29-终端与Claude-Code工作流.md"};function l(t,s,h,d,o,k){return n(),i("div",null,[...s[0]||(s[0]=[p(`<h1 id="终端-claude-code-工作流-用得好和用得烂差-5-倍生产力" tabindex="-1">终端 + Claude Code 工作流:用得好和用得烂差 5 倍生产力 <a class="header-anchor" href="#终端-claude-code-工作流-用得好和用得烂差-5-倍生产力" aria-label="Permalink to &quot;终端 + Claude Code 工作流:用得好和用得烂差 5 倍生产力&quot;">​</a></h1><p>打开你身边任何一个用 Claude Code 的同事,看他怎么用的。<strong>九成是这样</strong>:</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>他打开 VS Code,在底部 Terminal 里跑一个 claude</span></span>
