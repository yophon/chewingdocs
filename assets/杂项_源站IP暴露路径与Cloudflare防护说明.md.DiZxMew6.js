...
<span class="line"><span>upstream timed out while connecting to 1.2.3.4</span></span></code></pre></div><p>这些信息会直接指向后端或源站。</p><h3 id="_13-git-仓库、配置文件和部署脚本泄露" tabindex="-1">13. Git 仓库、配置文件和部署脚本泄露 <a class="header-anchor" href="#_13-git-仓库、配置文件和部署脚本泄露" aria-label="Permalink to &quot;13. Git 仓库、配置文件和部署脚本泄露&quot;">​</a></h3><p>项目代码或部署文件中可能写有源站地址：</p><div class="language-env vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">env</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>ORIGIN_HOST=1.2.3.4</span></span>
<span class="line"><span>API_BASE_URL=http://1.2.3.4:8080</span></span>
<span class="line"><span>SSH_HOST=1.2.3.4</span></span>
<span class="line"><span>DEPLOY_TARGET=1.2.3.4</span></span></code></pre></div><p>常见位置包括：</p><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>.env</span></span>
...
<span class="line"><span>必要时使用 Cloudflare Tunnel</span></span></code></pre></div><p>只要源站 IP 仍然可以被公网直接访问，Cloudflare 就只能保护通过域名进入的流量，不能阻止攻击方绕过它直接打源站。</p>`,207)])])}const g=s(l,[["render",t]]);export{u as __pageData,g as default};
