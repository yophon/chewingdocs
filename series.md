...
这套内容更适合按目标阅读，而不是从上到下通读：

- **补工程基础**：云服务与互联网基础常识、网络、操作系统、算法、程序员的数学。
- **做业务系统**：后端学习、系统设计、分布式系统、DevOps / SRE、数据工程。
- **做 AI 应用与平台**：AI 学习、AI Infra、数据工程、Claude Code。
- **做客户端与产品**：前端学习、Flutter、Android 原生开发、Android 平台基础、iOS 原生开发。
- **提升代码判断**：设计模式、解释器、Go、Rust、安全、Git、终端工程。

如果你是按职业目标补课,优先看：[学习路径](/学习路径)。
如果你想把多个系列串到真实项目里,看：[项目实战](/项目实战)。

[series-table:start]: #

| 系列 | 阅读入口 |
| --- | --- |
| AI 学习 | [AI学习路线总览](/aiLearning/01-AI学习路线总览) |
| AI Infra | [AI工程链总览](/aiInfraLearning/01-AI工程链总览) |
| 后端学习 | [后端学习路线总览](/backendLearning/01-后端学习路线总览) |
| 前端学习 | [前端学习路线总览](/webLearning/01-前端学习路线总览) |
| 设计模式 | [设计模式总览](/designPatternLearning/01-设计模式总览) |
| 云服务与互联网基础常识 | [云服务与互联网基础常识总览](/cloudBasicsLearning/01-云服务与互联网基础常识总览) |
| 系统设计 | [系统设计总览](/systemDesign/01-系统设计总览) |
| 分布式系统 | [分布式系统总览](/distributedLearning/01-分布式系统总览) |
| 网络 | [网络学习路线总览](/networkLearning/01-网络学习路线总览) |
